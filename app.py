...
def main():
    ...
    if st.button("Get Delivery Summary"):
        ...
        # If traffic is an error about geocoding or no route, show it and stop
        ...
        st.info("The following summary is generated by an AI language model (LLM) and may not be 100% accurate. Please verify critical information before making decisions.")
